    ...
    <div className="mt-6 hairline-t pt-6">
      ...
      <div className="flex flex-wrap items-center gap-2">
        <a
          ...
          className="inline-flex items-center justify-center h-9 w-9 rounded-full hairline hover:bg-[color:var(--color-surface-container)] transition-colors text-[color:var(--color-on-surface-variant)] hover:text-[color:var(--color-primary)]"
        >
