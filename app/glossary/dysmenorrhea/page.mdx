...
- Heat application (a dedicated <a href="https://www.amazon.com/s?k=heating+pad+menstrual+cramps&tag=lumencal0c-20" target="_blank" rel="sponsored noopener noreferrer" className="text-[color:var(--color-primary)] underline underline-offset-2 hover:opacity-70">heating pad for menstrual cramps</a> performs as well as ibuprofen in some head-to-head trials)
