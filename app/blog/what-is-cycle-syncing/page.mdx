...
<figure className="my-10">
  <img
    src="/blog/what-is-cycle-syncing/four-phases.png"
    alt="The four phases of the menstrual cycle: menstrual, follicular, ovulatory, luteal, with estrogen and progesterone curves"
    className="w-full hairline"
  />
  <figcaption className="mt-3 text-center text-[13px] italic text-[color:var(--color-on-surface-variant)]">
    Estrogen and progesterone across the four phases of a typical 28-day cycle.
  </figcaption>
</figure>
...
<figure className="my-10">
  <img
    src="/blog/what-is-cycle-syncing/womancode-alisa-vitti.jpg"
    alt="Alisa Vitti and the cover of WomanCode (2014)"
    className="w-full hairline"
  />
  <figcaption className="mt-3 text-center text-[13px] italic text-[color:var(--color-on-surface-variant)]">
    Alisa Vitti, author of <em>WomanCode</em> (2014), where the term cycle syncing was popularized.
  </figcaption>
</figure>
