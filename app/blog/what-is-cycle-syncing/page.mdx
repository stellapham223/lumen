...
<figure className="my-10">
  ...
  <figcaption className="mt-3 text-center text-[13px] italic text-[color:var(--color-on-surface-variant)]">
    <em>WomanCode</em> by Alisa Vitti (HarperOne, 2014), where the term <em>cycle syncing</em> was popularized. Cover image via <a href="https://openlibrary.org/books/OL26197923M/WomanCode" target="_blank" rel="noopener noreferrer" className="underline underline-offset-2 hover:opacity-70">Open Library</a>.
  </figcaption>
</figure>
