...
<aside className="my-8 hairline bg-[color:var(--color-surface-container-lowest)] p-6 sm:p-8">
  ...
  <p className="m-0 text-[16px] leading-relaxed text-[color:var(--color-on-surface)]">
    Cycle syncing is the practice of aligning work, exercise, food, and social demands to the four hormonal phases of the menstrual cycle (menstrual, follicular, ovulatory, luteal). The premise is that estrogen and progesterone fluctuations measurably affect cognition, energy, and mood, so planning around them outperforms treating every day identically. Effects are real but modest.
  </p>
</aside>
