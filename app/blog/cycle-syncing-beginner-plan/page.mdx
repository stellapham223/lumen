...
## Going deeper after month 1

If month 1 gave you a real signal and you want to read more, two books cover the territory from different angles. Skip both until you have your own tracked data; reading them before tracking biases what you look for.

- *<a href="https://www.amazon.com/s?k=In+the+FLO+Alisa+Vitti&tag=lumencal0c-20" target="_blank" rel="sponsored noopener noreferrer" className="underline underline-offset-2 hover:opacity-70">In the FLO</a>* by Alisa Vitti. The most-cited prescriptive book on cycle-aligned work, food, and exercise. Heavier on protocol than on uncertainty; useful as a structured plan if the four-phase model fit your tracking.
- *<a href="https://www.amazon.com/s?k=Period+Repair+Manual+Lara+Briden&tag=lumencal0c-20" target="_blank" rel="sponsored noopener noreferrer" className="underline underline-offset-2 hover:opacity-70">Period Repair Manual</a>* by Lara Briden, ND. The clinical counterweight. Briden is a naturopathic doctor; the book is more careful about claims and includes practical chapters on contraception, PCOS, and PMS that the Vitti framework treats lightly.
