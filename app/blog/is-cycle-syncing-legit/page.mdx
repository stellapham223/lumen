...
<aside className="my-8 hairline bg-[color:var(--color-surface-container-lowest)] p-6 sm:p-8">
  ...
  <p className="m-0 text-[16px] leading-relaxed text-[color:var(--color-on-surface)]">
    Cycle syncing is legit if you mean: hormonal fluctuations measurably affect cognition, and planning around them is useful. It is overstated if you mean: a specific commercial program is required for optimal female performance. The underlying physiology is well-replicated; the popular packaging often exceeds what the evidence supports.
  </p>
</aside>
