...
<aside className="my-8 hairline bg-[color:var(--color-surface-container-lowest)] p-4 sm:p-6 lg:p-8">
  ...
  <p className="m-0 text-[15px] sm:text-[16px] leading-relaxed text-[color:var(--color-on-surface)]">
    <strong>To start cycle syncing as a beginner: track one full cycle (energy, mood, focus daily) without changing anything, then in cycle two pick one decision area (work scheduling has highest leverage) and adjust based on phase.</strong> Evaluate after two cycles. Resist overhauling food, workouts, and social life simultaneously.
  </p>
</aside>
...
- **One book, after your first cycle.** Two are worth knowing about: *<a href="https://www.amazon.com/s?k=In+the+FLO+Alisa+Vitti&tag=lumencal0c-20" target="_blank" rel="sponsored noopener noreferrer" className="underline underline-offset-2 hover:opacity-70">In the FLO</a>* by Alisa Vitti for the full prescriptive four-phase model, and *<a href="https://www.amazon.com/s?k=Period+Repair+Manual+Lara+Briden&tag=lumencal0c-20" target="_blank" rel="sponsored noopener noreferrer" className="underline underline-offset-2 hover:opacity-70">Period Repair Manual</a>* by Lara Briden, ND, for the clinically-cautious counterweight. Read either one after your first tracked cycle, not before; reading first biases what you log.
